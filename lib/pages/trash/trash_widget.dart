  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<NotesRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<NotesRecord> trashNotesRecordList = snapshot.data!;
                                ...
                                child: Builder(
                                  builder: (context) {
                                    ...
                                    return MasonryGridView.builder(
                                      ...
                                      itemCount: siliknotes.length,
                                      itemBuilder: (context, siliknotesIndex) {
                                        final siliknotesItem =
                                            siliknotes[siliknotesIndex];
                                        return NotcardWidget(
                                          key: Key(
                                              'Keymm9_${siliknotesIndex}_of_${siliknotes.length}'),
                                          title: siliknotesItem.title,
                                          color: siliknotesItem.color,
                                          favorited: siliknotesItem.favorited,
                                          pinned: siliknotesItem.pinned,
                                          content: siliknotesItem.content,
                                          notesdoc: siliknotesItem,
                                          deleted: false,
                                        );
                                      },
                                    );
                                ...
                                child: Builder(
                                  builder: (context) {
                                    ...
                                    return MasonryGridView.builder(
                                      ...
                                      crossAxisSpacing: 10.0,
                                      mainAxisSpacing: 10.0,
                                      itemCount: silikaramasonuc.length,
                                      itemBuilder:
                                          (context, silikaramasonucIndex) {
                                        final silikaramasonucItem =
                                            silikaramasonuc[
                                                silikaramasonucIndex];
                                        return NotcardWidget(
                                          key: Key(
                                              'Keyxbb_${silikaramasonucIndex}_of_${silikaramasonuc.length}'),
                                          title: silikaramasonucItem.title,
                                          color: silikaramasonucItem.color,
                                          favorited:
                                              silikaramasonucItem.favorited,
                                          pinned: silikaramasonucItem.pinned,
                                          content: silikaramasonucItem.content,
                                          notesdoc: silikaramasonucItem,
                                          deleted: false,
                                        );
                                      },
                                    );
