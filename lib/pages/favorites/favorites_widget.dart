  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<NotesRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<NotesRecord> favoritesNotesRecordList = snapshot.data!;
                            ...
                            child: Align(
                              ...
                              child: Padding(
                                ...
                                child: Builder(
                                  builder: (context) {
                                    final favnotes =
                                        favoritesNotesRecordList.toList();
                                    ...
                                    return MasonryGridView.builder(
                                      ...
                                      itemBuilder: (context, favnotesIndex) {
                                        final favnotesItem =
                                            favnotes[favnotesIndex];
                                        return NotcardWidget(
                                          key: Key(
                                              'Keysla_${favnotesIndex}_of_${favnotes.length}'),
                                          title: favnotesItem.title,
                                          color: favnotesItem.color,
                                          favorited: favnotesItem.favorited,
                                          pinned: favnotesItem.pinned,
                                          content: favnotesItem.content,
                                          notesdoc: favnotesItem,
                                          deleted: false,
                                        );
                                      },
                                    );
                                ...
                                child: Builder(
                                  builder: (context) {
                                    ...
                                    return MasonryGridView.builder(
                                      ...
                                      crossAxisSpacing: 10.0,
                                      mainAxisSpacing: 10.0,
                                      itemCount: favaramasonuc.length,
                                      itemBuilder:
                                          (context, favaramasonucIndex) {
                                        final favaramasonucItem =
                                            favaramasonuc[favaramasonucIndex];
                                        return NotcardWidget(
                                          key: Key(
                                              'Keyq5q_${favaramasonucIndex}_of_${favaramasonuc.length}'),
                                          title: favaramasonucItem.title,
                                          color: favaramasonucItem.color,
                                          favorited:
                                              favaramasonucItem.favorited,
                                          pinned: favaramasonucItem.pinned,
                                          content: favaramasonucItem.content,
                                          notesdoc: favaramasonucItem,
                                          deleted: false,
                                        );
                                      },
                                    );
